 ...
 * MAKE-MAC-PSK-DHE 4-message vulnerable protocol.
 *
 ...
 *  - reusing A's authenticator to authenticate to B
 *
 */

public class AdvMAkeMacIKEILV extends SecProBase
{
    ...
    public AdvMAkeMacIKEILV(AppComm appComm, String locId, byte[] sessionId,
     ...
     *  - intercept AuthBA -> derive attack success and forward to A
     */
    public byte[] recvAuthMsg(AuthMsg msg) throws Exception
    {
        ...
        case INIT_RCVD:
            ...
            // Forward Ana's authenticator to Bob unchanged
        ...
        case AUTH_SENT:
            ...
            //aborts session S1 explicitly using FAIL_B.
